...
$(function() {
	...
	$("#output_kejiju_renyuan_button").bind('click', function() {
		...
		var param = {
		    ...
		    date1 : $("#output_kejiju_renyuan_createTime1").val() == "" ? '1900-12-31' : $("#output_kejiju_renyuan_createTime1").val(),
		    date2 : $("#output_kejiju_renyuan_createTime2").val() == "" ? '3000-12-31' : $("#output_kejiju_renyuan_createTime2").val(),
